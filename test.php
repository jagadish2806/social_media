...
<div class="main">
            ...
            <form name="form1" class="form1" method="post" >
              ...
              <input type="file" class="form-control-file UserName" name="file" id="file" required>
            </div>
            <div class="form-group">  
                <label for="Comment">Comment</label>
                <input type="Comment" class="form-control" name="Comment" id="Comment" placeholder="Comment" required>
              </div>
